...
import GenericCard from './ReusableComponents/GenericCard'
    ...
    <div className="bg-black">
      ...
      <div className="w-full min-h-screen container mx-auto py-9 bg-transparent">
        <div className="grid grid-cols-3 gap-10  mt-4 mb-4 mx-auto py-36">
          <CardHVF />
          <GenericCard title={"live trading days"} image={TradingDaysLogo} description={"Join Francis & the Sniper Community in a Live Session"} />
          <GenericCard title={"stream archives"} image={MarketsLogo} description={"Watch Previous Streams"} />
        </div>
      </div>
    </div>
  )
