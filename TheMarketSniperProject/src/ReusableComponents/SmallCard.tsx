...
export default function SmallCard({ icon, title, image, description} ) {
  return (
    <div className="h-5/5 transition duration-500 ease-in-out shadow-2xl hover:shadow-yellow-500 bg-zinc-900 cursor-pointer rounded-2xl transform hover:scale-90 w-3/3 hover:shadow-[0_0_30px_green]">    
