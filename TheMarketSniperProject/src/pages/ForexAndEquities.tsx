              ...
              >
                <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
                    ...
                    <div className="sm:flex sm:items-start">
                      ...
                      <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                        <Dialog.Title as="h3" className="text-1xl underline font-bold leading-6 text-gray-900">
                          SESSION 1 FOREX & EQUITIES
                        </Dialog.Title>
                        <div className="mt-8">
                          <p className="text-sm text-gray-500 font-semibold">
                            Live Trading Day Session 1: Non Farm Payrolls October 2023 6 October @ 11:30 - 13:00 UTC+0
                          </p>
                        </div>
                        <div className="mt-6">
                          <p className="text-sm text-gray-500 font-semibold">
                        ...
                        <div className="mt-6">
                          <p className="text-gray-500 font-bold">Oct 6, 2023, 12:30 – 2:00 PM (Europe/London)</p>
                  ...
                  <div className="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                    <Link to={"https://meet.goto.com/748097189"}>
                      <button
                        type="button"
