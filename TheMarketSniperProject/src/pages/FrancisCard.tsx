...
export default function FrancisCard() {
  return (
            <div className="relative w-full group max-w-md min-w-0 mx-auto mt-6 mb-6 break-words bg-white border shadow-2xl dark:bg-gray-800 dark:border-gray-700 md:max-w-sm rounded-xl transition duration-500 ease-in-out shadow-2xl hover:shadow-green-500 rounded-2xl transform hover:scale-60">
                <div className="pb-6">
